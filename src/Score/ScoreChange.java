	...
	public void jButton1_actionPerformed(ActionEvent e) {
		...
		try {
			...
			while (rs.next()) {
				...
				System.out.println("原来的分数："+old_score);
			}
			rs.close();
		} catch (Exception ce) {
			System.out.println("++++++++" + ce);
		...
		try {
			if(Float.valueOf(xueFen)<old_score){
				jOptionPane3.showMessageDialog(this,"重考分数低于原来的分数，更新失败", "提示", JOptionPane.INFORMATION_MESSAGE, null);
				...
				jOptionPane2.showMessageDialog(this,"分数应在0~100之间，请重新输入", "提示", JOptionPane.INFORMATION_MESSAGE, null);
			}
